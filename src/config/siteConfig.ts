...
export const siteConfig: SiteConfig = {
	title: "FlyingFlame's Blog",
	subtitle: "记录技术、学习与生活",
	siteURL: "https://flyinglandlord.github.io/",
	siteStartDate: "2020-08-13",
	keywords: ["FlyingFlame", "flyinglandlord", "计算机科学", "个人博客"],
	...
	navbarTitle: {
		...
		icon: "https://github.com/flyinglandlord.png?size=96",
		// 网站Logo图片路径
	...
	banner: {
		...
		src: {
			desktop: ["/assets/banner/anime-city-river.webp"], // 桌面横幅图片
			mobile: ["/assets/banner/anime-city-river.webp"], // 移动横幅图片
		}, // 使用本地横幅图片
